...
//		System.out.println(BurgerArray.size());
	...
	public void paintComponent(Graphics g) {
		...
		//주문버거 그리기
		for(int i=0; i<burger.ImageorderIngredients.size(); i++) {
			int orderX=500;
			int orderY=100;
			Image image = burger.ImageorderIngredients.get(i);
			
//			if(i+1>1) {
//				orderY = orderY - (20*(BurgerArray.size()+1));
//				//토마토 또는 패티면 30 더 밑으로
//				if(ingredients.equals("tomato") || ingredients.equals("patty")) {
//					orderY = orderY + 30;
//				}
...
//				}
//			}
			g.drawImage(image, orderX, orderY, this);
			orderY+=30;
		}
