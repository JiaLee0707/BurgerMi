		...
		while(true) {
			if (size == BurgerMi.game.order.orderBurger.size()) {
				...
				break;
					...
					|| !((((List<Object>) BurgerMi.game.order.orderBurger.get(i)).get(0) == ((List<Object>) BurgerMi.game.order.MakeBurger.get(i)).get(0)))) {
				System.out.println("실패");
				
				break;
			} else if (((List<Object>) BurgerMi.game.order.orderBurger.get(i)).get(0) == ((List<Object>) BurgerMi.game.order.MakeBurger.get(i)).get(0)) {
				size++;
			}
			i++;
		}
